        ...
        DO jm = 1, m-1
          DO ja = 1, a
            READ(3,*) &
              symbol(jm,ja), coor(jm,ja,:)
            IF (symbol(jm,ja) == 'Li') symbol(jm,ja) = 'M'
          END DO
        END DO
        ...
        DO jm = m, m
          DO ja = 1, a
            READ(3,*) &
              symbol(jm,ja), coor(jm,ja,:)
            IF (symbol(jm,ja) == 'N') symbol(jm,ja) = 'N2'
            IF (symbol(jm,ja) == 'O') symbol(jm,ja) = 'O2'
            IF (symbol(jm,ja) == 'Be') symbol(jm,ja) = 'M2'
          END DO
        END DO
        ...
        DO jm = m, m
          DO ja = 1, a
            WRITE(4,300) symbol(jm,ja), coor(jm,ja,:), 'NO2', jm
          END DO
        END DO

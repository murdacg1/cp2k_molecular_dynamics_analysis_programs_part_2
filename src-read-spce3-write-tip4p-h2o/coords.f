...
! 0.1280120648689 0.1280120648689                                          a_par b_par parameters (so that r_OM=0.15A (r_OH=0.9572A, q_HOH=104.52deg) ! TIP4P
! 0.131937768191546 0.131937768191546                                      a_par b_par parameters (so that r_OM=0.1546A (r_OH=0.9572A, q_HOH=104.52deg) ! TIP4P_2005
